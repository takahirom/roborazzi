...
//        test.outputs.dir(snapshotOutputDir)
        ...
        test.systemProperties["roborazzi.test.working.directory.path"] =
          project.layout.projectDirectory.asFile.absolutePath.toString()
        test.systemProperties["roborazzi.report.snapshot.root.path"] =
          project.rootProject.layout.projectDirectory.asFile.absolutePath.toString()
